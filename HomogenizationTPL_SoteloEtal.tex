...
The pioneering work of \citeA{White1975a} and \citeA{White1975} is one of the first to show the effective viscoelastic behavior of simple poroelastic composites saturated with gas and water. Specially, the model of periodically alternating poroelastic beds \cite{White1975} has been applied to represent thin layers of interest and to study their reflectivity response at normal incidence. In this modeling approach the thin layer consists of a stack of alternating poroelastic beds that are homogeneous and isotropic. This thin layer representation is specifically convenient for
testing the sensitivity of various poroelastic parameters as it allows the computation of its effective moduli by analytical means \cite<e.g.,>{Carcione2006, Krzikalla2011}. For instance,  \citeA{Quintal2009} and \citeA{Quintal2011a} use this thin layer representation to compare the reflection coefficients at normal incidence of viscoelastic substitutes of various thin layer models characterized by alternating beds with different rock and fluid properties. Whereas, \citeA{He2020} utilize a particular version of this model to represent a thin layer containing fractures. To achieve this, they consider that 
the bed representing the fracture is much softer and thinner than the other one. \cite{Brajanovski2005,Kong2013}. In their study, they use viscoelastic substitutes of fractured thin layers to examine the effect of various fluids and fracture physical properties on the variation of seismic amplitude with respect to the angle of incidence. A general assumption in the homogenization of a layered TPL is that the TPL should consist of a periodic heterogeneous structure, e.g., a pair of beds, that repeats a sufficient number of times so that its effective behavior is, for practical purposes, unaffected by the boundary conditions (BC) induced by the background embedding the TPL. However, a more realistic and flexible model to depict layered TPL for reflectivity analyses is to consider a TPL with a finite number of beds that present distinct rock and fluid properties. In such a case, BC induced by the embedding background are likely to affect the estimation of the effective moduli.
