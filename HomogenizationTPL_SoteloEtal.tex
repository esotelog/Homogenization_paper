...
\caption{Maps of the real part of the vertical  stress component   obtained for TPL2 samples a) $\Omega_e$  and b) $\Omega$ (Figure \ref{fig.7}). Maps of the real part of the vertical strain  obtained for the same TPL2 samples c) $\Omega_e$  and d) $\Omega$. 
The sample $\Omega_e$ incorporates background with a thickness that is half of the TPL2's.
