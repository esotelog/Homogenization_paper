...
in elastic-half spaces $\Lambda_1$ and $\Lambda_2$ (Figure \ref{fig.1}a and Table \ref{table.1}). To test the proposed method, we follow the procedure described below: 
\begin{enumerate}
    ...
    \item Then, using these equivalent medium, we calculate PP reflectivities  at the its interface with the upper half-space $\Lambda_1$ and the equivalent viscoelastic medium. Appendix B details the methodology for the PP reflectivity calculation.
...
\begin{figure}[!ht]
\centering
        \includegraphics[width= 80mm, height=70mm]{Figure7.eps}
...
\begin{figure}[!ht]
\centering
        \includegraphics[width= 130mm, height=160mm]{Figure9.eps}
...
\begin{figure}[!ht]
\centering
        \includegraphics[width= 130mm, height=140mm]{Figure12.eps}
